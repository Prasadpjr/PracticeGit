...
public class FetchingData {
	@DataProvider(name="hashDataProvider")  //providing date from excel
	public static Object[][] getTestData(Excel_Reader xls_received, String testName, String sheetName) throws Exception{
		
		Excel_Reader xls = xls_received; //Excel file 
	
		String testCaseName = testName; //name of cases 
		
		String testDataSheet = sheetName; //sheet names of excel
		
		int testStartRowNumber=1;		 //Start row number of excel =1
		
		while(!(xls.getCellData(testDataSheet,1, testStartRowNumber).equals(testCaseName))){
			testStartRowNumber++;
			//here comparing Data sheet 1st row and 1st column value compared with test name 
		}
	...
	public static boolean isRunnable(Excel_Reader xls_received, String tName, String sheet){
		
		String sheetName = sheet;

		Excel_Reader xls = xls_received;
